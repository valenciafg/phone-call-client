...
class MoreDurationCallsForm extends Component {
    constructor(...args) {
        super(...args)
        this.state = {
            start: Moment().format(),
    ...
    handleSubmit(event) {
        ...
        this.props.getMoreDurationCalls(data)
    }
    render(){
        return(
...
export default connect(mapStateToProps,{getMoreDurationCalls})(MoreDurationCallsForm)
